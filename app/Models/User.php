...
class User extends Authenticatable
{
    ...
    public function peaceSessions(): HasMany
    {
        return $this->hasMany(PeaceSession::class);
    }

    public function rosaryProgress(): HasMany
    {
        return $this->hasMany(RosaryProgress::class);
    }
